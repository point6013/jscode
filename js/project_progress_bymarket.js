...
function module2Main() {
    ...
    if (data !== undefined && Object.keys(data).length !== 0) {
        ...
        echarts3Option();
         $("#table2_wrapper .DTFC_LeftBodyLiner").css("overflow-y","hidden");
    } else {
        html += `
                    <div class="col-lg-4" style="display: inline-block;padding: 0.2rem;">
...
function renderModule3(data, params) {
    if(detectZoom() == 150){
        ...
        $(".exportParent").css("margin-right","6px");
    }else {
        $(".exportSpan").css("display","inline-block");
        $(".exportParent").css("margin-right","22px");
    }
...
function electronicFormFn() {
    ...
    $(".elementIframe").contents().find(".dataTables_scrollBody").css("max-height","230px")
