...
/*
 * @Author: Huang Meng
 * @Date: 2021-01-28 17:41:00
 * @LastEditTime: 2021-07-15 16:43:43
 * @LastEditors: your name
 * @Description: 
 * @FilePath: \jscode\stg_new_store.js
...
result =JSON.parse(cfs1.request.python.pythonWeb('store_aging_dashboard', paraobj).res)
var newSQLStr = "";
var year_list =result.res2;
var sql_total =result.res3;
var html_var = result.res4;
...
function renderModule1(){
    ...
    var sqlParam = `SELECT
                    ...
                    counts>=1 then 1 else null end) sale_2021, ${sql_total[0]}
...
function renderModule2(){
    ...
    var sqlParam = `SELECT
                    ...
                    counts>=1 then 1 else null end) CF_2021,  ${sql_total[2]}                  
...
function renderModule3(){
    ...
    var sqlParam = `
                ...
                sum(case when Cal_Year='2021' and counts>=1 then CF else null end)/1000 /sum(case when Cal_Year='2021'and counts>=1  then Inv else null end) cash_roi_2021,${sql_total[4]}
                ...
                sum( CASE WHEN Cal_Year = '2021' and counts>=1 THEN margin_fee ELSE NULL END )	/sum(case when Cal_Year='2021' and counts>=1 then TNS else null end)  M_margin_2021,${sql_total[5]}
                ...
                sum(case when Cal_Year='2021' and counts>=1 then CF else null end)/1000 /sum(case when Cal_Year='2021' then Inv else null end) cash_roi_2021,${sql_total[4]}
                ...
                sum( CASE WHEN Cal_Year = '2019' THEN margin_fee ELSE NULL END )	/sum(case when Cal_Year='2019' then TNS else null end)  M_margin_2019,
                sum( CASE WHEN Cal_Year = '2020' and counts>=1 THEN margin_fee ELSE NULL END )	/sum(case when Cal_Year='2020' and counts>=1 then TNS else null end)  M_margin_2020,
                sum( CASE WHEN Cal_Year = '2021' and counts>=1 THEN margin_fee ELSE NULL END )	/sum(case when Cal_Year='2021' and counts>=1 then TNS else null end)  M_margin_2021,${sql_total[0]}
                sum( CASE WHEN Cal_Year = 'ttm' and counts>=1 THEN margin_fee ELSE NULL END )	/sum(case when Cal_Year='ttm' and counts>=1 then TNS else null end)  M_margin_ttm
